        ...
        <ul class="items">
            ...
            <li>
                ...
                <div class="banner">
                    ...
                    <p class="text-2">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie
                        consequat.</p>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="banner">
                    ...
                    <p class="text-2">Feugiat nulla facilisis at vero erots et accumsan et iusto odio dignis sim qui
                        blandit.</p>
                </div>
            </li>
        </ul>
    ...
    <div class="container_12">
        <div class="grid_12 box-1">
            ...
            <div class="extra-wrap">
                ...
                <p>Le Bora-Bora Hôtel & Spa, a été construit en 1998 dans un style moderne et comporte des
                    bungalows.</p>
                <p>Dans la baie de Kanumera, près du lagon, l’hôtel séduit par son luxe sage dans une atmosphère unique
                    alliant modernité et gastronomie.</p>
            </div>
        </div>
